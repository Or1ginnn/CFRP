...
def test_resample_rebuilds_six_anchor_plus_three_recent_visual_history(tmp_path: Path):
    ...
    assert [Path(path).name for path in migrated["model_input"]["visual_history_paths"]] == [
        "frame-0019.npy", "frame-0024.npy", "frame-0030.npy", "frame-0035.npy", "frame-0041.npy",
        "frame-0047.npy", "frame-0048.npy", "frame-0049.npy", "frame-0050.npy",
    ]
